    ...
    <AnimatePresence initial={false}>
      {show && (
        <motion.div
          ...
          animate='visible'
          exit='hidden'
          className='z-50 bg-white w-screen h-screen absolute left-0 right-0 flex items-center justify-center'
        >
          <svg
          ...
          >
            <defs>
              <clipPath id='clip-e'>
                <rect x='9' y='9' width='97' height='97' fill='#C4C4C4' />
              </clipPath>
              <clipPath id='clip-n'>
                <rect x='114' y='9' width='97' height='97' fill='#C4C4C4' />
              </clipPath>
              <clipPath id='clip-z'>
                <rect x='220' y='9' width='97' height='97' fill='#C4C4C4' />
              </clipPath>
              <clipPath id='clip-o'>
                <rect x='325' y='9' width='97' height='97' fill='#C4C4C4' />
              </clipPath>
            </defs>
            <g
              style={{
                clipPath: 'url(#clip-e)',
                animation: '0.3s 0.2s both fadeIn ease-out'
              }}
            >
            ...
            <g
              style={{
                clipPath: 'url(#clip-n)',
                animation: '0.3s 0.3s both fadeIn ease-out'
              }}
            >
            ...
            <g
              style={{
                clipPath: 'url(#clip-z)',
                animation: '0.3s 0.4s both fadeIn ease-out'
              }}
            >
            ...
            <g
              style={{
                clipPath: 'url(#clip-o)',
                animation: '0.3s 0.5s both fadeIn ease-out'
              }}
            >
